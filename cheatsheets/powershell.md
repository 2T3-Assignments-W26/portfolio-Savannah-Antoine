...
![powershellicon](..\cheatsheets\PowerShell_5.0_icon.png)
...
|Get current location   |`Get-Command`                    |`pwd`         |
...
![Ise Panes pic](..\cheatsheets\ISE_panes.png)
...
![vscode image](..\cheatsheets\vs_code.png)
